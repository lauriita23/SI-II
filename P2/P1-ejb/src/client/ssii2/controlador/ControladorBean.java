...
public class ControladorBean implements Serializable {
    ...
    public String enviarVoto() {
		ssii2.servicio.VotoBean votoAux;
		...
		//traducirVotoParaServicio(this.voto);
	    if (dao.compruebaCenso(traducirVotoParaServicio(this.voto).getCenso()) == false) {
	    ...
	    /* Registramos el voto */
	    votoAux = dao.registraVoto(traducirVotoParaServicio(this.voto));
